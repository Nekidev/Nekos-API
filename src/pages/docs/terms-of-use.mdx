...
- You <u>must </u> store the content served by the API for more than an hour. This includes but is not limited to any API response, partially or complete.
...
WE ARE NOT THE COPYRIGHT HOLDERS OF THE IMAGES PROVIDED BY THE API. THIS MEANS THAT WE ARE NOT RESPONSIBLE FOR ANY COPYRIGHT INFRINGEMENTS. IF YOU ARE THE COPYRIGHT HOLDER OF ANY IMAGE AND YOU WANT IT TO BE REMOVED, PLEASE CONTACT US AT [dmca@nekos.nekidev.com](mailto:dmca@nekos.nekidev.com).