...
export default async function checkRateLimit(req, res = null) {
    ...
    if (timeout >= timeout_limit) {
        ...
        if (res) {
            ...
            throw new GraphQLError("You have exceeded the rate limit too many times. Please try again later.") 
        }
        return false;
        ...
        if (res) {
            ...
            throw new GraphQLError("You have exceeded the rate limit. Please try again later.")
        }
        return false;
    }
